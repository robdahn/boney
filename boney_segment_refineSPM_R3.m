...
clscor.help = 'Boney refinement of SPM tissue classes described by the transferred tissue volume transfer between classes.';
  ...
  % new refinement block 
    ...
    Ypx(Ypx==-3 & Ypt<20 & cat_vol_smooth3X(Yc{4} .* Ypp,sx)>0.01 & Ypp>.33 & Yb<.5 & (Ym<tismri.head_muscle.*0.5.*Ypp.*2.*Yppc & Ym<2*Yppc .* (tis.CSF*.5+.5*tis.GM)) & (Ya<9 | Ya==12)) = 0;  
    Ypx(Ypx==-3 & Ypt<20 & cat_vol_smooth3X(Yc{4} .* Ypp,sx)>0.01 & Ypp>.66 & Yb<.5 & Ym<(3.*Yppc) & (Ym<tismri.head_muscle.*Yppc*.4 | Ym>tismri.head_muscle*1.2 ) & (Ya<9 | Ya==12)) = 0;  
    Ypx(Ypx==-3 & Ypt>20 & Ybrd>1 & Ym>tismri.head_muscle*1.2) = -1;
    Ypx(Ypx==-3 & Ypp<0.5 & Ybg<.5) = -1;
    Ypx(Ypx==-3 & Ypt<20 & Yb<.5 & Ypp>.5 & Yppc>.8 & (Ym<ith | Ym>tismri.head_muscle.*1.2.*(1+Ypp)) & (Ya<9 | Ya==12)) = 0;
