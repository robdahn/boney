function [Ybonepp, Ybonethick, Ybonemarrow, Yheadthick, val] = boney_segment_extractbone(Vo,Yo,Ym,Yc,Ye,Ya,Ymsk,seg8t,tis,out,opt,vx_vol,RES,BB)
%% * Report: 
...
%   
  ...
  if opt.output.writevol
    ...
    %cat_io_writenii(Vo,Ybonemid,out.P.mridir,sprintf('bonemid%d_',opt.opts.bmethod), ...
    ...
    cat_io_writenii(Vo,Ybonepp,out.P.mridir,sprintf('bonepp%d_',opt.opts.bmethod), ...
    ...
    cat_io_writenii(Vo,Ybonemarrow,out.P.mridir,sprintf('bonemarrow%d_',opt.opts.bmethod), ...
      'bone percentage position map','uint16',[0,0.001], ... 
      min([1 0 2],[job.output.bonemarrow.native job.output.bonemarrow.warped job.output.bonemarrow.dartel]),trans);
    cat_io_writenii(Vo,Ybonethick,out.P.mridir,sprintf('bonethickness%d_',opt.opts.bmethod), ...
    ...
    cat_io_writenii(Vo,Yheadthick,out.P.mridir,sprintf('headthickness%d_',opt.opts.bmethod), ...
