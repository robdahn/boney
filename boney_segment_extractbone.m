...
if job.opts.refine >= 2 % with filter
  ...
  if job.output.writevol
    ...
    cat_io_writenii(Vo,Ybonemarrow,out.P.mrirdir,sprintf('bonemarrow%d_',job.opts.bmethod), ...
    ...
    % no modulation here 
    cat_io_writenii(Vo,Ybonepp,out.P.mrirdir,sprintf('bonepp%d_',job.opts.bmethod), ...
    ...
    cat_io_writenii(Vo,Ybonethick,out.P.mrirdir,sprintf('bonethickness%d_',job.opts.bmethod), ...
    ...
    cat_io_writenii(Vo,Yheadthick,out.P.mrirdir,sprintf('headthickness%d_',job.opts.bmethod), ...
