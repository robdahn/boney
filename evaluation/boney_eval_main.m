...
if exist('/Users/robertdahnke/MRData/Boney/','dir')
  maindirs  = {
    '/Users/robertdahnke/MRData/Boney/'; 
    '/Users/robertdahnke/MRData/Boney/'; 
    '/Users/robertdahnke/MRData/Boney/'; 
    };
elseif exist('/Volumes/SG5TB/MRData/202301_MRIbones/','dir')
  maindirs  = {
...
resdir    = '_20240427_reslim1.5_mltmsk2';
...
matonly = 12;   
opts = struct('matonly',matonly,'rerun',0,'output',struct('resdir',['../derivatives/Boney' resdir]));
...
opts.output.report     = 0;     % write report (0-no, 1-fast, 2-full visual that took ~5 seconds longer) 
...
opts.opts.bnorm        = 'WM';  % WM, GM, CSF, fat, muscle,'GM-WM-contrast'
opts.opts.classic      = 1; 
