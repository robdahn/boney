...
%%
use_vals   = { 
  [8 9 11 3 7 4 5 6 39 41:44 2 15 12 13 14]  [ 18 19 22 29 32 8 9 11 15 12 13 14  ] 'bone & fat' [2 3 4 5 8 9]  [4 9 13 14 15];   % bone [BMD, brain, age]
  [8 9 11 3 7 4 5 6 39 41:44 2 15 12 13 14 ]  [ 8 16:19 20:23 27 28 24 25 7 4 5 6 39 29 30:33 37 38 34 2 15 12 13 14  ] 'bone & fat' [1 5 13 18 19 26 27 28]  [4 9 13 14 15]; %supplement figure
...
for uvi = 1:size(use_vals,1)
  ...
  %%
  print(gcf,fullfile(sprintf('Msc_2024_table%02d.png', uvi )),'-dpng','-r1600'); 
