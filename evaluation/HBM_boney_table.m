...
both_corr  = cat_io_csv(fullfile(boneyEvalDir,'HBM_2024','boney_correlation_proper.csv')); 
...
use_vals   = { 
  [ 9 10 12  ,  2:5 , 1 13 , 15 19 16:18      ]  [ 6 7 8  , 9 10 12  ,  2:5 ] 'bone' [3 7 8 9]  [3 7];   % bone [BMD, brain, age]
  [ 2:5 , 1 15:21                  ]  [ 14      ,            2:5 ] 'fat'  [3     ]  [3  ];    % fat  [
  [ 9 10 12  ,  2:5 , 1 13 , 15 19 16:18 20:21 ]  [ 6 7 8 14, 9 10 12 ,  2:5 ] 'bone' [3 7 8 9 14]  [3 4 7];   % bone [BMD, brain, age]
};
